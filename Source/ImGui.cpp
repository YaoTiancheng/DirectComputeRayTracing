...
bool CDirectComputeRayTracing::ProcessImGuiWindowMessage( HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam )
{
    return ImGui_ImplWin32_WndProcHandler( hWnd, msg, wParam, lParam );
}

bool CDirectComputeRayTracing::InitImGui( HWND hWnd )
{
    IMGUI_CHECKVERSION();
...
void CDirectComputeRayTracing::ShutdownImGui()
{
...
void CDirectComputeRayTracing::DrawImGui( ID3D12GraphicsCommandList* commandList )
{
    ImGui::Render();
