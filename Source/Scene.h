...
public:
    ...
    bool XM_CALLCONV TraceRay( DirectX::FXMVECTOR origin, DirectX::FXMVECTOR direction, float tMin, struct SRayHit* outRayHit, struct SRayTraversalCounters* outCounters = nullptr ) const;
